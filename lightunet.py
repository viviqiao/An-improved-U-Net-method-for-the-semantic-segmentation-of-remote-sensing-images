...
def scheduler(epoch):
    if (epoch % 1 == 0 and epoch != 0):
        model.save('lightunet' + str(epoch) + '.h5')
    return K.get_value(model.optimizer.lr).astype('float32')


def lightunet(pretrained_weights=None, input_size=(256, 256, 3)):
    ...
    dropadd1 = Dropout(0.1)(convadd1)
    pooladd1 = MaxPooling2D(pool_size=(2, 2))(dropadd1)
    ...
    dropadd2 = Dropout(0.1)(convadd2)
    pooladd2 = MaxPooling2D(pool_size=(2, 2))(dropadd2)
    ...
    dropadd3 = Dropout(0.1)(convadd3)
    pooladd3 = MaxPooling2D(pool_size=(2, 2))(dropadd3)
    ...
    merge7 = concatenate([drop3, up7], axis=caxis)
    conv7 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge7)
    #conv7 = Conv2D(256, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv7)

    up8 = Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(conv7))
    merge8 = concatenate([drop2, up8], axis=caxis)
    conv8 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge8)
    #conv8 = Conv2D(128, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv8)

    up9 = Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(conv8))
    merge9 = concatenate([drop1, up9], axis=caxis)
    conv9 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge9)
    #conv9 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv9)

    up10 = Conv2D(32, 3, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(conv9))
    merge10 = concatenate([dropadd3, up10], axis=caxis)
    ...
    merge11 = concatenate([dropadd2, up11], axis=caxis)
    ...
    up12 = Conv2D(8, 3, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(conv11))
    merge12 = concatenate([dropadd1, up12], axis=caxis)
...
def train(args):
    ...
    model = lightunet()
    keras.utils.plot_model(model, "lightunetModel.png", show_shapes=True)
    ...
    callbacks_list = [
        ...
        keras.callbacks.TensorBoard(log_dir='lightunetlog6', update_freq=1000)
    ]
    global H
    ...
    try:
        ...
        plt.savefig('lightunet.png')
        with open('lightunet.txt', 'wb') as file_pi:
            pickle.dump(H.history, file_pi)
    except:
        model.save('lightunet.h5')
        with open('lightunettrainHistoryDict1.txt', 'wb') as file_pi:
            pickle.dump(H.history, file_pi)
    else:
        model.save('lightunet.h5')
        with open('lightunethis.txt', 'wb') as file_pi:
            pickle.dump(H.history, file_pi)
